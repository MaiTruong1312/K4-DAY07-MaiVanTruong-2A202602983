...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Split text while capturing sentence boundaries
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        if not remaining_separators:
            # If no separators left, split rigidly by chunk_size
            chunks = []
        ...
        for part in splits:
            ...
            if len(piece) > self.chunk_size:
                # If adding single piece exceeds chunk_size, process current_chunk first
                if current_chunk:
